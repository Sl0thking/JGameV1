...
public class DefaultGameSystem {
	...
	public DefaultGameSystem(String systemID, Class<? extends GameEvent> listeningEvent, IEntityManagement entityManager, List<GameEvent> eventQueue) {
		super();
	...
	public DefaultGameSystem(String systemID, IEntityManagement entityManager) {
		super();
		this.setEntityManager(entityManager);
